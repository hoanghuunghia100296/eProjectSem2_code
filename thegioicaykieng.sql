...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 16, 2021 lúc 05:54 AM
...
(1, 'Catus Flower', 1, '2021-08-24', 100, 1, 'guest/img/bg-img/40.png', 'ttttttttttttt'),
...
--
ALTER TABLE `order_detail`
  MODIFY `SeqNum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
